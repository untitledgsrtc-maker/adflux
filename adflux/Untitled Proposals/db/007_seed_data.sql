-- =====================================================================
-- UNTITLED PROPOSALS — Migration 007: Seed Data (UPDATED 2026-04-24)
-- Pre-fills: media types, 20 GSRTC stations, 33 Auto districts,
--           Auto DAVP rate, sample team member (Brijesh as default signer).
--
-- CHANGES FROM ORIGINAL DRAFT:
--   - Added sample team_members row so proposal PDFs have a default signer
--   - Otherwise identical to uploaded draft (corrected GSRTC counts intact)
-- =====================================================================
...
-- =====================================================================
-- GSRTC STATIONS (corrected per latest screenshot: Valsad = 14 screens)
...
-- Only insert if no active row exists.
-- =====================================================================
...
-- =====================================================================
-- TEAM MEMBERS (sample default signer — Brijesh)
-- Used as default on PDFs until users add their own from the UI.
-- Phone left as a placeholder so PDFs render without nulls.
-- =====================================================================
insert into public.team_members
  (name_en, name_gu, designation_en, designation_gu, mobile, email, display_order, is_active)
values
  ('Brijesh Patel',
   'બ્રિજેશ પટેલ',
   'Director',
