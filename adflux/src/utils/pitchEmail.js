  ...
  const html = `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#05070f;">
    <tr><td align="center" style="padding:26px 12px;">
      ...
      <table role="presentation" class="wrap" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#0A0E1A;border:1px solid #1b2233;border-radius:16px;overflow:hidden;">
        ...
        ${greetRow}
        <!-- HERO — real station footage (animated GIF, taps to the live video) -->
        <tr><td style="background:#0A0E1A;padding:0;line-height:0;">
          <a href="https://app.untitledad.in/led" style="display:block;text-decoration:none;">
            <img src="https://app.untitledad.in/email/station-hero.gif" width="600" alt="GSRTC bus-station LED screens — live footage" style="display:block;width:100%;max-width:600px;height:auto;border:0;">
          </a>
        </td></tr>
        <tr><td class="pad" style="background:#0A0E1A;padding:24px 30px 2px 30px;">
          ...
          <div class="px px-h1" style="font-family:'Space Grotesk',Arial,sans-serif;color:#ffffff;font-size:34px;line-height:38px;font-weight:700;margin-top:12px;">We don't hope your ad was seen. <span style="color:#FFE600;">We prove it.</span></div>
          <div class="bd" style="font-family:'DM Sans',Arial,sans-serif;color:#c3cad6;font-size:15px;line-height:22px;margin-top:14px;">Real screens, real stations. LED screens inside Gujarat's busiest bus stands — a camera on every screen counts the real people who saw your ad, and a QR turns them into a WhatsApp lead.</div>
          <a href="https://app.untitledad.in/led" class="px" style="display:inline-block;margin-top:16px;font-family:'Space Grotesk',Arial,sans-serif;color:#0A0E1A;background:#FFE600;font-size:13px;font-weight:700;padding:10px 20px;border-radius:999px;text-decoration:none;">&#9658; Watch it live &#8594;</a>
        </td></tr>
        ...
        <tr><td class="pad" style="background:#0A0E1A;padding:28px 30px 6px 30px;">
          <div class="px" style="font-family:'Space Grotesk',Arial,sans-serif;color:#ffffff;font-size:20px;font-weight:700;">A billboard can't tell you who looked.<br><span style="color:#FFE600;">Ours can.</span></div>
