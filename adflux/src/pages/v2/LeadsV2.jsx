  ...
  return (
    <div className="lead-root">
      ...
      <div className="lead-filter-row">
        ...
        {/* Phase 145 — Phase 139 clarity caption removed: it sat inside
            the flex filter row and cramped the search + tabs (owner: "this
            line disturbs UI"). The stage-vs-tasks distinction is understood;
            if needed again, surface it as a tab tooltip, not an inline line. */}
