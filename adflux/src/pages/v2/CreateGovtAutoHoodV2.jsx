...
export default function CreateGovtAutoHoodV2() {
  ...
  async function handleSave(targetStatus = 'draft') {
    ...
    const quotePayload = {
      ...
      auto_total_quantity: Number(data.auto_total_quantity) || 0,
  ...
  return (
    <GovtWizardShell
      ...
      title="New DAVP Auto Hood Proposal"
      steps={stepLabels}
      step={step}
      goBack={goBack}
      goNext={goNext}
